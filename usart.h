...
#define USART1 ((struct zmcu_usart *)0x40013800)
#define USART2 ((struct zmcu_usart *)0x40004400)
#define USART4 ((struct zmcu_usart *)0x40004C00)
#define USART5 ((struct zmcu_usart *)0x40005000)
...
void usart_set_baud_rate(struct zmcu_usart *usart, uint16_t baud_rate);
